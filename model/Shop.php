...
public static function getApplynum($shop_id,$f_type){
    ...
    public static function postAccountApplay($shop,$admin_id,$transfer){
    global  $_GPC,$_W;
    ...
    $shop_id=$shop['shop_id'];
        ...
        $arr = array();
            ...
            Message::admin_acount($title,'￥'.$am.'(含手续费：'.$transfer.'元)',$admin_user['nickname'],$arr['addtime'],$id,$paytype);
            return $id;
         }
